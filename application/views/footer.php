...
<script defer src="<?php echo site_url()."includes/admin/";?>js/mylibs/jquery-ui-1.8.15.custom.min.js"></script> <!-- jQuery UI -->
...
<script defer src="<?php echo site_url()."includes/admin/";?>js/mylibs/jquery.dataTables.min.js"></script> <!-- Tables -->
<script defer src="<?php echo site_url()."includes/admin/";?>js/mylibs/jquery.tipsy.js"></script> <!-- Tooltips -->
<script defer src="<?php echo site_url()."includes/admin/";?>js/mylibs/excanvas.js"></script> <!-- Charts -->
<script defer src="<?php echo site_url()."includes/admin/";?>js/mylibs/jquery.visualize.js"></script> <!-- Charts -->
<script defer src="<?php echo site_url()."includes/admin/";?>js/mylibs/jquery.slidernav.min.js"></script> <!-- Contact List -->
